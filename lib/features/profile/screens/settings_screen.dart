    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text('Settings', style: TextStyle(color: AppConstants.textColor)),
            backgroundColor: AppConstants.primaryBackground,
              ...
              SettingsGroup(
                children: [
                  SettingsItem(
                    ...
                    title: 'Theme Mode',
                    subtitle: SettingsDialogs.getThemeModeName(ThemeManager().currentThemeMode),
                    onTap: () => SettingsDialogs.showThemeModeSelectionDialog(context),
                    isFirst: true,
                  ),
                  ...
                  SettingsItem(
                    ...
                    title: 'App Theme',
                    subtitle: SettingsDialogs.getThemeName(ThemeManager().currentTheme),
                    onTap: () => SettingsDialogs.showThemeSelectionDialog(context),
                  ),
                  const SettingsDivider(),
                  SettingsItem(
                    icon: Icons.view_list_outlined,
                    title: 'List Style',
                    subtitle: SettingsDialogs.getListStyleName(SettingsManager().currentListStyle),
                    onTap: () => SettingsDialogs.showListStyleSelectionDialog(context),
                    isLast: true,
                  ),
                ],
              ),
              ...
              SettingsGroup(
                children: [
                  SettingsItem(
                    ...
                    subtitle: SettingsDialogs.getContentPreferencesText(SettingsManager().contentPreferences),
                    onTap: () => SettingsDialogs.showContentPreferencesDialog(context),
                    isFirst: true,
                    isLast: true,
                  ),
                ],

...
class ThemeManager extends ChangeNotifier with WidgetsBindingObserver {
  ...
  static const String _themeModeKey = '${AppConstants.prefixStorageKey}theme_mode_pref';
  static const String _appThemeKey = '${AppConstants.prefixStorageKey}app_theme_pref';
